...
namespace Mojiex
{
    ...
    public class MenuItemAdd : MonoBehaviour
    {
        ...
        private static void MyTest(MenuCommand menuCommand)
        {
            ...
            CreateTxtFile(FormatComTemplate(select.transform, "Assets/Mojiex/Editor/GameObject/UIPanelComTemplate.cs.txt"), select.name + "Com");
        ...
        private static void CreateTxtFile(string content, string name)
        {
