    ...
    public class ExcelReader
    {
        ...
        public static void TestReflection()
        {
            ...
            for (int i = 0; i < files.Length; i++)
            {
                ...
                //MDebug.Log(Type.GetType("MapData"));
            ...
            CreateBinaryFile(PlayerPrefabHelper.EncryptString(handler), "ExcelDataHandler", ConstFilePath.ExcelAssetWritePath);
        ...
        private static void CreateExcelDataScript(FileInfo info, ref string name)
        {
            ...
            for (int i = 0; i < columnNum; i++)
            {
                ...
                if (str.Length != 2)
                {
                    throw new ArgumentException($"Data must be style : variableName:variableType.Wrong row index : {i},{rowNum},{columnNum},{collection[1][i]}");
                }
